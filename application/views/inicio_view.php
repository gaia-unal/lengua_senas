...
<td>
    <!--SE AGREGO PARA BUSCAR LAS CATEGORIAS EN FORMA DE GLOSARIO-->
    <a href="index.php/glosario"><img src="<?php echo base_url() ?>style/inicio/img/glosario17.png" alt="botón para el glosario" width="120%" class="act4 imgHover" /></a>
</td>
