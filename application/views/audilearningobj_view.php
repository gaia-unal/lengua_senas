...
$id = $_GET['id'];
$act = $_GET['act'];
$arrayLetras = array('casa', 'ventana', 'abrigo', 'desodorante', 'regla', 'blusa', 'caja', 'billete', 'gafas', 'lapiz','pantalon','televisor', 'jaula', 'pastilla', 'tablero', 'vestido', 'llave',
'boleta', 'arbol', 'botella', 'guantes','botas', 'espejo', 'camara', 'computador', 'pelota', 'Felicitaciones');
...
<p>
  ...
  <h4>
    <center>
    ¡ Hola !, Cada ítem está identificado por una letra (a,b,c), al frente de cada ítem se visualiza una casilla con unas opciones de respuesta, lo primero es dar click sobre la modelo de la izquierda para activar la seña, si conoces el objeto que ella emite, ve a la casilla del frente correspondiente y escribe el valor del ítem que con el que se asocia.<br><br>
  </center>
  </h4>
  ...
  if ($id==475869) {
    ...
    <br>
    <a href="audilearningobj?id=<?php echo($act);?>&act=<?php echo($act);?>"><input type="button" name="name" value="nuevamente" class="btn btn-primary" id="incorrecto"></a>
    <br><br><br>
    </center>
    <?php
  }elseif ($id==941826) {
    ...
    <br>
    <a href="audilearningobj?id=<?php echo($act+2);?>&act=<?php echo($act+2);?>"><input type="button" name="name" value="continuar" class="btn btn-primary" id="correcto"></a>
    <br><br><br>
    </center>
    <?php
...
?>
<form class="" action="validationaudilearningobj" method="post">
...
<table width="100%">
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/objetos/<?php echo ($posLetra1) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video><br>
    </td>
    <td align="center">
      <img src="<?php echo base_url()?>style/inicio/img/obje/<?php echo $buena1; ?>.png" alt="botón para la acividad de respuesta correcta" width="20%" class=""/>
  ...
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/objetos/<?php echo ($posLetra2) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video><br>
    ...
    <td align="center">
    <br><br>
      <img src="<?php echo base_url()?>style/inicio/img/obje/<?php echo $buena2; ?>.png" alt="botón para la acividad de respuesta correcta" width="20%" class=""/>
  ...
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/objetos/<?php echo ($posLetra3) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video><br>
      <?php
      $ani = 2; ?>
    ...
    <td align="center">
    <br><br>
      <img src="<?php echo base_url()?>style/inicio/img/obje/<?php echo $buena3; ?>.png" alt="botón para la acividad de respuesta correcta" width="20%" class=""/>
