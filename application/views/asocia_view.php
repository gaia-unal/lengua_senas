...
<td>
<a href="asocianum?id=1&act=1"><img src="<?php echo base_url()?>style/inicio/img/numeros.png" alt="botón para la acividad de respuesta correcta" width="80%" class="act2 imgHover"/></a>
</td>
<td>
<a href="asociaalf?id=1&act=1"><img src="<?php echo base_url()?>style/inicio/img/alfabeto.png" alt="botón para la acividad de selección múltiple" width="80%" class="act3 imgHover"/></a>
</td>
</tr>
</table>
</div>
...
<body style="overflow-y:hidden" id="inicio">
