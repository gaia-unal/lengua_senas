...
<header id="inicio">
        <div class="container" >
            <div class="row">
                <div class="col-lg-12">
                  <div class="" >
                        <span class="nameQue"><font color="#7DBC51"><strong><h1>Saludos y Agradecimientos</strong></h1></font></span>
                    </div>
...
<tr>   
  <td>
  <h1><strong>&nbsp;&nbsp;buenas noches</strong></h1>
  <video id="demo1" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo1').play()" >
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/buenas_noches.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
  
  <td>
  <h1><strong>&nbsp;&nbsp;buenas tardes</strong></h1>
  <video id="demo2" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo2').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/buenas_tardes.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
  <td>
  <h1><strong>&nbsp;&nbsp;buenos días</strong></h1>
  <video id="demo3" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo3').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/buenos_dias.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
...
<tr>
  <td>
  <h1><strong>&nbsp;&nbsp;con gusto</strong></h1>
  <video id="demo4" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo4').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/con_gusto.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
  
  <td>
  <h1><strong>&nbsp;&nbsp;diculpa</strong></h1>
  <video id="demo5" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo5').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/disculpa.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
  <td>
  ...
  <video id="demo6" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo6').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/gracias.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
...
<tr>
  <td>
  <h1><strong>&nbsp;&nbsp;hasta mañana</strong></h1>
  <video id="demo7" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo7').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/hasta_mañana.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
  ...
  <video id="demo8" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo8').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/hola.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>

  <td>
  <h1><strong>&nbsp;&nbsp;lo siento</strong></h1>
  <video id="demo9" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo9').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/lo_siento.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
...
<tr>
  <td>
  <h1><strong>&nbsp;&nbsp;por favor</strong></h1>
  <video id="demo10" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo10').play()">
    <source src="<?php echo base_url()?>style/inicio/videos/saludosyagradecimientos/por_favor.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  </td>
