...
<p align="center">
 ...
 <h4>
	 <center>
	 La modelo nos muestra un número en lengua de señas. En la parte inferior se encuentra activa una casilla. Escribe la respuesta correcta de acuerdo a lo que ella nos indica
...
<video id="demo" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo').play()">
    ...
    Tu navegador no implementa el elemento <code>video</code>.
			...
			<input type="text" name="nombre" value="" autocomplete="off" required><br><br><br>
