...
<p>
  ...
  <h4>
    <center>
    ¡ Hola !, Cada ítem está identificado por una letra (a,b,c), al frente de cada ítem se visualiza una casilla con unas opciones de respuesta, lo primero es dar click sobre la modelo de la izquierda para activar la seña, si conoces la letra que ella emite, ve a la casilla del frente correspondiente y escribe el valor del ítem que con el que se asocia.<br><br>
  </center>
  </h4>
  ...
  if ($id==475869) {
    ...
    <br>
    <a href="audilearningalf?id=<?php echo($act);?>&act=<?php echo($act);?>"><input type="button" name="name" value="nuevamente" class="btn btn-primary" id="incorrecto"></a>
    <br><br><br>
    </center>
    <?php
  }elseif ($id==941826) {
    ...
    <br>
    <a href="audilearningalf?id=<?php echo($act+2);?>&act=<?php echo($act+2);?>"><input type="button" name="name" value="continuar" class="btn btn-primary" id="correcto"></a>
    <br><br><br>
    </center>
    <?php
...
?>
<form class="" action="validationaudilearningalf" method="post">
...
<table width="100%">
  ...
  <video id="demo1" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo1').play()">
    ...
    <td align="center">
      <img src="<?php echo base_url()?>style/inicio/img/alfa/<?php echo $buena1; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
      <input type="text" id="option1" name="option1" value="" min="0" required="required" autocomplete="off">
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td align="center">
    <br><br>
      <img src="<?php echo base_url()?>style/inicio/img/alfa/<?php echo $buena2; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
  ...
  <tr>
    ...
    <td align="center">
    <br><br>
      <img src="<?php echo base_url()?>style/inicio/img/alfa/<?php echo $buena3; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
