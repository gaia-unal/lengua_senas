...
$arrayLetras = array('t', 'd', 'c', 's', 'u', 'o', 'h', 'n', 'p', 'i', 'e', 't','a','r', 'y', 'm', 'x', 'z', 'b', 'f',
'g', 'v', 'j', 'q', 'k', 'l','p', 'w', 'Felicitaciones');
$pos = $array[$act-1];
...
<p align="center">
 ...
 <h4>
   <center>
   La modelo nos muestra una letra en lengua de señas. En la parte inferior se encuentra las opciones de respuesta. Elige la opción correcta de acuerdo a lo que ella nos indica
...
?>
  ...
  <form class="" action="validationeligealf" method="post">
    ...
    if ($id==475869) {
      ...
      $first = substr($posCorrecto,0,2);    // devuelve "f"
       ?>
      <font color="#E11B2B" size="4px"><?php echo "¡Debe ser otra letra!"; ?></font><br><br>

      <a href="eligealf?id=<?php echo($act);?>&act=<?php echo($act);?>"><input type="button" class="btn btn-primary" name="name" value="Nuevamente" id="incorrecto"></a>
      <br>
      ...
      <font color="#7DBC51" size="4px">¡ Lo has hecho maravillosamente, presiona el botón continuar !</font><br><br>

  <br>
      <a href="eligealf?id=<?php echo($act+1);?>&act=<?php echo($act+1);?>"><input type="button" class="btn btn-primary" name="name" value="Continuar" id="correcto"></a>
  <br>
      <?php
...
<table>
  ...
  <strong>a)</strong> 
    ...
    <td>
      <input type="radio" style="width:30px;height:30px" name="CorrectOption" value="<?php echo $buena1; ?>" required>
...
<table border="0" width="100%">
  ...
  <td>
    ...
    <td width="80%" align="center">
      ...
      color:white; ">ELEGIR - ALFABETO</div></font> 
    </td>
