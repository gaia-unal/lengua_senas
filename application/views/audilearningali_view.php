...
$id = $_GET['id'];
$act = $_GET['act'];
$arrayLetras = array('banano', 'cafe', 'empanada', 'chocolate', 'aguacate', 'cebolla', 'galleta', 'lechuga', 'manzana', 'naranja', 'papaya', 'arepa','pizza', 'pollo', 'tamal', 'tomate',
'arroz', 'carne', 'fresa', 'limon', 'mandarina', 'panela','mango', 'aceite', 'Felicitaciones');
...
<p>
  ...
  if ($id==475869) {
    ...
    <br>
    <a href="audilearningali?id=<?php echo($act);?>&act=<?php echo($act);?>"><input type="button" name="name" value="nuevamente" class="btn btn-primary" id="incorrecto"></a>
    <br><br><br>
    </center>
    <?php
  }elseif ($id==941826) {
    ...
    <br>
    <a href="audilearningali?id=<?php echo($act+2);?>&act=<?php echo($act+2);?>"><input type="button" name="name" value="continuar" class="btn btn-primary" id="correcto"></a>
    <br><br><br>
    </center>
    <?php
...
?>
<form class="" action="validationaudilearningali" method="post">
...
<table width="100%">
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/alimentos/<?php echo ($posLetra1) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video><br>
    </td>
    <td align="center">
      <img src="<?php echo base_url()?>style/inicio/img/alim/<?php echo $buena1; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
  ...
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/alimentos/<?php echo ($posLetra2) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video><br>
    ...
    <td align="center">
    <br><br>
      <img src="<?php echo base_url()?>style/inicio/img/alim/<?php echo $buena2; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
  ...
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/alimentos/<?php echo ($posLetra3) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video><br>
      <?php
      $ani = 2; ?>
    ...
    <td align="center">
    <br><br>
      <img src="<?php echo base_url()?>style/inicio/img/alim/<?php echo $buena3; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
...
<table border="0" width="100%">
  ...
  <td>
    ...
    <td width="80%" align="center">
      ...
      color:white; ">ALIMENTOS</div></font> 
    </td>
