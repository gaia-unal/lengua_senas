...
$id = $_GET['id'];
$act = $_GET['act'];
$arrayLetras = array('tres', 'diez', 'cinco', 'siete', 'cuatro', 'uno', 'ocho', 'nueve', 'dos', 'seis', 'diecisiete', 'veintidos','treinta', 'cien',
'doscientos', 'quinientos', 'seiscientos', 'ochocientos','mil', 'tresmil', 'cincomil', 'Felicitaciones', 'Adios');
...
<p>
  ...
  <h4>
    <center>
    ¡ Hola !, Cada ítem está identificado por una letra (a,b,c), al frente de cada ítem se visualiza una casilla con unas opciones de respuesta, lo primero es dar click sobre la modelo de la izquierda para activar la seña, si conoces el número que ella emite, ve a la casilla del frente correspondiente y escribe el valor del ítem que con el que se asocia.<br><br>
  </center>
  </h4>
  ...
  if ($id==475869) {
    ...
    <br>
    <a href="audilearningnum?id=<?php echo($act);?>&act=<?php echo($act);?>"><input type="button" name="name" value="nuevamente" class="btn btn-primary" id="incorrecto"></a>
    <br><br><br>
    </center>
    <?php
  }elseif ($id==941826) {
    ...
    <br>
    <a href="audilearningnum?id=<?php echo($act+2);?>&act=<?php echo($act+2);?>"><input type="button" name="name" value="continuar" class="btn btn-primary" id="correcto"></a>
    <br><br><br>
    </center>
    <?php
...
?>
<form class="" action="validationaudilearningnum" method="post">
...
<table width="100%">
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/numeros/<?php echo ($posLetra1) ?>.mp4" type="video/mp4">
    ...
    <td>
    <img src="<?php echo base_url()?>style/inicio/img/nums/<?php echo $buena1; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
          <font size="5%"><strong><?php echo $buena1; ?></strong></font><br>

      <input type="text" id="option1" name="option1" value="" min="0" title="Respuesta incorrecta" required="required" autocomplete="off"><br>
  ...
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/numeros/<?php echo ($posLetra2) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
  ...
  <br>
    ...
    <br><br>
      ...
      <img src="<?php echo base_url()?>style/inicio/img/nums/<?php echo $buena2; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
      <font size="5%"><strong><?php echo $buena2; ?></strong></font><br>
  ...
  <tr>
    ...
    <source src="<?php echo base_url()?>style/inicio/videos/numeros/<?php echo ($posLetra3) ?>.mp4" type="video/mp4">
    Tu navegador no implementa el elemento <code>video</code>.
  </video>
    ...
    <br><br>
      ...
      <img src="<?php echo base_url()?>style/inicio/img/nums/<?php echo $buena3; ?>.png" alt="botón para la acividad de respuesta correcta" width="30%" class=""/>
      <font size="5%"><strong><?php echo $buena3; ?></strong></font><br>
      <input type="text" id="option2" name="option3" value="" min="0" required="required" autocomplete="off">
    </td>
  </tr>
</table>
<?php
