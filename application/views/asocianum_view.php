...
$id = $_GET['id'];
$act = $_GET['act'];
$arrayLetras = array('tres', 'diez', 'cinco', 'siete', 'cuatro', 'uno', 'ocho', 'nueve', 'dos', 'seis', 'diecisiete', 'veintidos','treinta','cuarenta', 'cincuenta', 'setenta', 'ochenta', 'cien', 'quinientos', 'noventa', 'ochocientos', 'doscientos', 'seiscientos', 'cuatrocientos','mil', 'tresmil', 'cincomil', 'millon', 'Felicitaciones', 'Adios');
...
<p>
  ...
  if ($id==475869) {
    ...
    <br>
    <a href="asocianum?id=<?php echo($act);?>&act=<?php echo($act);?>"><input type="button" name="name" value="nuevamente" class="btn btn-primary" id="incorrecto"></a>
    <br><br><br>
    </center>
    <?php
  }elseif ($id==941826) {
    ...
    <br>
    <a href="asocianum?id=<?php echo($act+2);?>&act=<?php echo($act+2);?>"><input type="button" name="name" value="continuar" class="btn btn-primary" id="correcto"></a>
    <br><br><br>
    </center>
    <?php
...
?>
<form class="" action="validationasocianum" method="post">
...
<table width="100%">
  ...
  <video id="demo1" autoplay="autoplay" width="380" height="300" onclick="document.getElementById('demo1').play()">
    ...
    <td>
      <input type="text" class="form-control" id="option1" name="option1" value="" min="0" title="Respuesta incorrecta" required="required" autocomplete="off"><br>
  ...
  <tr>
    ...
    <td>
      <input type="text" class="form-control" id="option2" name="option2" value="" min="0" title="Respuesta incorrecta" required="required" autocomplete="off"><br>
  ...
  <tr>
    ...
    <td>
      <input type="text" class="form-control" id="option3" name="option3" value="" min="0" title="Respuesta incorrecta" required="required" autocomplete="off"><br>
...
<table border="0" width="100%">
  ...
  <td>
    ...
    <td width="80%" align="center">
      ...
      color:white; ">ASOCIAR - NÚMEROS</div></font> 
    </td>
